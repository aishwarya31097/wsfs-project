    ...
    BDBReport = async (formData) => {
        ...
        try {
            ...
            if (this.state.OrgName == "wsfstrustee") {
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/rtl2/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/builder/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/npl/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/stoa2022/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/unlock/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
                            ...
                            {/* <div className="row">
                                <div className="col-md-12 text-left">
                                    <ul className="navigation_top">
                                        ...
                                        <li className="float-left"> <Button variant={this.state.loan_strat_report == true ? 'contained' : 'outlined'} onClick={this.loan_strat_report} color='primary' type='submit'> Download Servicer Summary  </Button> </li>
