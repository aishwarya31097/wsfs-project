...
const Downloadschema = require('./Downloadschema.json');
...
class ViewLoanDataTape extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            loadingFormDownloadschema: false,
    ...
    switchType = async (switchType, formData) => {
        ...
        } else if (switchType == "download_servicer") {

            this.download_servicer();
            this.setState({ formDataDownload: formData, header_dealId: formData.dealId });
    ...
    download_servicer = async () => {

        this.setState({
            download_servicer: true,
            loan_strat_report: false,
            trustee_report: false,
        })
        let all_deals = this.state.all_deals;
        ...
        let oldSchema = this.state.Downloadschema;
        console.log("Downloadschema", oldSchema);
        ...
        console.log("Downloadschema oldSchema", newSchema);
        // this.setState({ schema: newSchema});
        this.setState({ Downloadschema: newSchema, loadingFormDownloadschema: true });
    }
    ...
    BDBReport = async (formData) => {
        ...
        try {
            ...
            if (this.state.OrgName == "wsfstrustee") {
            ...
            else if (this.state.DealType == "Saluda BC2") {
                let poolidold = JSON.stringify({
                    'Deal Name': {
                        'type': 'in',
                        'value': [formData.dealId.replace(/[^a-zA-Z0-9]+/g, "").toLowerCase()],
                ...
                let mailid = this.state.emailid;
                let password = this.state.Pass;
                const res = await axios.get(process.env.react_app_base_url + "backendapi_wsfs_bdb/api/v1/bc2/link?groupby=" + formData.groupby + '&mailid=' + mailid + '&password=' + password + '&month=' + formData.month + '&year=' + formData.year + '&DealName=' + formData.dealId);
                if (res.status == 204) {
                    this.setState({ bdbUrl: "UrlBdbNew", test: null, bdb_loader: false })
    ...
    onSubmitDownload = async (value) => {
        if(this.state.button==1){
        // this.setState({formDataDownload :value.formData})
        ...
        if (this.state.DealType == "LimaOne") {
            ...
            APIResponse =process.env.react_app_base_url + 'backendapibc2/downloadfile?file=' + file + '&file2=' + file2
        }  
        else if(this.state.DealType == "Saluda Builders"){
            APIResponse =process.env.react_app_base_url + 'backendapibuilders/downloadfile?file=' + file + '&file2=' + file2
        }
        else if(this.state.DealType == "NPL"){
            APIResponse =process.env.react_app_base_url + 'backendapinpl/downloadfile?file=' + file + '&file2=' + file2
        }
        else if(this.state.DealType == "Stoa 2022"){
            APIResponse =process.env.react_app_base_url + 'backendapistoa2022/downloadfile?file=' + file + '&file2=' + file2
        }  
        else if(this.state.DealType == "Unlock"){
            APIResponse =process.env.react_app_base_url + 'backendapiunlock/downloadfile?file=' + file + '&file2=' + file2
        }
        else {
        ...
        if (this.state.DealType == "LimaOne") {
            ...
            APIResponse =process.env.react_app_base_url + 'backendapibc2/downloadfilepost?file=' + file + '&file2=' + file2
        } 
        else if(this.state.DealType == "Saluda Builders"){
            APIResponse =process.env.react_app_base_url + 'backendapibuilders/downloadfilepost?file=' + file + '&file2=' + file2
        }
        else if(this.state.DealType == "NPL"){
            APIResponse =process.env.react_app_base_url + 'backendapinpl/downloadfilepost?file=' + file + '&file2=' + file2
        }
        else if(this.state.DealType == "Stoa 2022"){
            APIResponse =process.env.react_app_base_url + 'backendapistoa2022/downloadfilepost?file=' + file + '&file2=' + file2
        }  
        else if(this.state.DealType == "Unlock"){
            APIResponse =process.env.react_app_base_url + 'backendapiunlock/downloadfilepost?file=' + file + '&file2=' + file2
        }
        else {
        ...
        if (APIResponse != null) {
            ...
            if (parseInt(APIResponse.data) === 0) {
                ...
                if (LoanTapeData != null) {
                    ...
                    this.setState({ download_servicer: false, loan_strat_report: true })
    ...
    export_pdf = async (event) => {
        ...
        if (ConstGeneratePDF != null) {
            ...
            if (this.state.DealType == "LimaOne") {
                ...
                filepath = process.env.react_app_base_url + "backendapibc2/" + file_name
                // filepath = "http://localhost:3005/" + file_name
            }
            else if (this.state.DealType == "Saluda Builders") {
                filepath = process.env.react_app_base_url + "backendapibuilders/" + file_name
                // filepath = "http://localhost:3005/" + file_name
            }
            else if (this.state.DealType == "NPL") {
                filepath = process.env.react_app_base_url + "backendapinpl/" + file_name
                // filepath = "http://localhost:3005/" + file_name
            }
            else if (this.state.DealType == "Stoa 2022") {
                filepath = process.env.react_app_base_url + "backendapistoa2022/" + file_name
                // filepath = "http://localhost:3005/" + file_name
            }
            else if (this.state.DealType == "Unlock") {
                filepath = process.env.react_app_base_url + "backendapiunlock/" + file_name
                // filepath = "http://localhost:3005/" + file_name
            }
            downloadFile(filepath);
                ...
                <div className="page">
                    <div className="content">
                            ...
                            <div className="row">
                                <div className="col-md-12 text-left">
                                    ...
                                    <ul className="navigation_top">
                                        ...
                                        <li className="float-left"> <Button variant={this.state.download_servicer == true ? 'contained' : 'outlined'} onClick={this.download_servicer} color='primary' type='submit'> Download Servicer Summary  </Button> </li>
                        ...
                        {/* {this.state.dashboard_bdb == true ?
                            ...
                            : ''} */}
                        {this.state.download_servicer == true ?
                       
                               <div className="page-content text-center" id="formElements2">
                                   <div className="row">
                                     
                                       <div className="col-md-12">
                                           <div class="threecolform">
                                               {this.state.loadingFormDownloadschema == true ?
                                                   <Form
                                                       schema={this.state.Downloadschema}
                                            ...
                                            <React.Fragment>
                                                ...
                                                <span className="small_text">Download is based on the uploaded month</span>
                                            </React.Fragment>
                                                                                                    ...
                                                                                                    {key == "Definitions" ?
                                                                                                        ...
                                                                                                        <React.Fragment>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <div class="beforeClass"></div>
                                                                                                                    <Table section_id={key} channelname={this.state.channelname} type="summery" data={value} section_title={key} month={this.state.formDataLoanStrat.month} year={this.state.formDataLoanStrat.year}></Table>
                                                ...
                                                {this.state.report_data == null ? '' :
                                                    <React.Fragment>
                                                        ...
                                                        <React.Fragment>
                                                            ...
                                                            <ViewDragNDrop
                                                            customize_data={this.state.report_data}
                                                            dealname={this.state.formDataLoanStrat.dealId}
                                                            month={this.state.formDataLoanStrat.month}
                                                            year={this.state.formDataLoanStrat.year}
                                                            peers={this.state.peers}
                                                            token={this.state.token}
                                                            dealType={this.state.DealType}
                                                            channelname={this.state.channelname}
