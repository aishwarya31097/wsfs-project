...
class AcquisitionCriteriaTable extends React.PureComponent {
    render() {
        ...
        return (
            <React.Fragment>
                {/* {JSON.stringify(this.props.data[0][0])} */}
                                                ...
                                                return (
                                                    <React.Fragment>
                                                        {value.length == 0  && key.length != 0 && key.length !== 1?
                                                            ...
                                                            :
                                                            <tr>
                                                                <td className={key == "Total:" ? 'total' : key == "Total: " ? 'total'  : key == "BeginningBalance" ? 'bolditem' : key == "EndingBalance" ? 'bolditem' : key == "AdjustedEndingBalance" ? 'bolditem' : key == "AdjustedEndingBalance " ? 'bolditem' : key == "AdjustedEndingBalance " ? 'bolditem':''}
                                                                >{key.replace(/([a-z])([A-Z])/g, '$1 $2')}</td>
                                                                <td >
