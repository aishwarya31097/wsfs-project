...
class PercentageStat extends React.PureComponent {
    ...
    render() {
        ...
        if ((((parseInt(this.props.month) <= 9 && parseInt(this.props.year) == 2021) || parseInt(this.props.year) == 2020)) && this.props.dealType != "AlphaFlow") {
                ...
                {this.props.data == null ? '' :
                    this.props.data.length != 0 ?
                        <div className="wrapper-pdf" id={this.props.section_id}>
                            ...
                            {(((parseInt(this.props.month) <= 9 && parseInt(this.props.year) == 2021) || parseInt(this.props.year) == 2020) && this.props.dealType != "AlphaFlow") ?
